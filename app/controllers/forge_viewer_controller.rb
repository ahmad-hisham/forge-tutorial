class ForgeViewerController < ApplicationController
  def view
    ...
    # Redirect to viewer
    redirect_to ForgeViewer.get_viewer_link(access_token, params[:project_id], params[:item_id], params[:viewer_id])
  end
  ...
  def view_object
    ...
    # Redirect to viewer
    redirect_to ForgeViewer.get_viewer_link_from_object(access_token, object_id, params[:viewer_id])
  end
end
